...
public class DefaultDataTableHelper : IDataTableHelper
{
    ...
    public string ReadData(string dataTableName) {
        var path = AssetUtility.GetDataTable(dataTableName);
        var asset = ResourceManager.Instance.LoadAsset(path) as TextAsset;
